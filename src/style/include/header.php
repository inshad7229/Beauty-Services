                    ...
                    <div class="collapse navbar-collapse">
                        <ul class="nav navbar-nav navbar-left cus-navbar">
                            ...
                            <ul class="sub-service dropdown-content">
                                <li>
                                    <a href="javascript:void(0);">Hair Coloring</a>
                                </li>
                                <li>
                                    <a href="javascript:void(0);">Women's Haircut</a>
                                </li>
                                <li>
                                    <a href="javascript:void(0);">Men's Haircut</a>
                                </li>
                                <li>
                                    <a href="javascript:void(0);">Hair Trimming</a>
                                </li>
                                <li class="see-all">
                                        <a href="javascript:void(0);">View Hair Treatment
                ...
                <div class="col-md-5 col-sm-5 col-xs-12">
                    <div class="pull-right left-navbar">
                       <ul class="right-login">
                            <li><a href="#" data-toggle="modal" data-target="#signupAs">Sign Up</a></li>
            ...
            <div class="sign-selectoption">
                <div class="col-md-12 col-xs-12 col-sm-12 p-0">
                    <div class="col-md-6 col-xs-12  col-sm-6 right-border">
                        ...
                        <a  class="cus-btn btn" href="saloon-signup.php">Saloon</a>
                    </div>
                    <div class="col-md-6 col-xs-12  col-sm-6">
                        ...
                        <a class="cus-btn btn" href="customer-signup.php">Customer</a>
                    </div>
                </div>
            </div>
        </div>
